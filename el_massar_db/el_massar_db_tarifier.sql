...
CREATE TABLE `tarifier` (
  `id_tarifier` int NOT NULL,
  `code_categorie` int NOT NULL,
  `nombre_etoiles` int NOT NULL,
  PRIMARY KEY (`id_tarifier`),
  KEY `fk_coca_id` (`code_categorie`),
  KEY `fk_nbretoiles_id` (`nombre_etoiles`),
  CONSTRAINT `fk_coca_id` FOREIGN KEY (`code_categorie`) REFERENCES `categorie` (`code_categorie`),
  CONSTRAINT `fk_nbretoiles_id` FOREIGN KEY (`nombre_etoiles`) REFERENCES `classes` (`nombre_etoiles`)
