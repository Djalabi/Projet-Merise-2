...
CREATE TABLE `chambres` (
  ...
  KEY `fk_hot_id` (`id_hotel`),
  KEY `fk_cc_id` (`code_categorie`),
  CONSTRAINT `fk_cc_id` FOREIGN KEY (`code_categorie`) REFERENCES `categorie` (`code_categorie`),
  CONSTRAINT `fk_hot_id` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id_hotel`)
