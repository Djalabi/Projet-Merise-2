...
CREATE TABLE `consommations ` (
  `numero_consommation` int NOT NULL,
  `date_consommation` date DEFAULT NULL,
  `heure_consommation` varchar(30) NOT NULL,
  `code_cl` int NOT NULL,
  PRIMARY KEY (`numero_consommation`),
  KEY `fk_cl_id` (`code_cl`),
  CONSTRAINT `fk_cl_id` FOREIGN KEY (`code_cl`) REFERENCES `client` (`code_cl`)
